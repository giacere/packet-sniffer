    ...
    ($val:expr, $index:expr, $name:expr) => {
        if let Some(p) = $val.get(&$index) {
            match p {
                ...
                _ => {
                    println!("Failed to decode {}", $name);
                    None
                }
            }
        } else {
            println!("Index {} not found in {}", $index, $name);
            None
        }
    };
}
...
impl HealthUpdate {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("HealthUpdate parameters: {:?}", val);
...
impl RegenerationHealthChanged {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("RegenerationHealthChanged parameters: {:?}", val);
...
impl KnockedDown {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("KnockedDown parameters: {:?}", val);
...
impl NewCharacter {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("NewCharacter parameters: {:?}", val);
...
impl UpdateFame {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("UpdateFame parameters: {:?}", val);
...
impl CharacterEquipmentChanged {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("CharacterEquipmentChanged parameters: {:?}", val);
...
impl PartyInvitation {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyInvitation parameters: {:?}", val);
...
impl PartyJoined {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyJoined parameters: {:?}", val);
...
impl PartyDisbanded {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyDisbanded parameters: {:?}", val);
...
impl PartyPlayerJoined {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyPlayerJoined parameters: {:?}", val);
...
impl PartyChangedOrder {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyChangedOrder parameters: {:?}", val);
...
impl PartyPlayerLeft {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyPlayerLeft parameters: {:?}", val);
...
impl PartyLeaderChanged {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyLeaderChanged parameters: {:?}", val);
...
impl PartyLootSettingChangedPlayer {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyLootSettingChangedPlayer parameters: {:?}", val);
...
impl PartySilverGained {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartySilverGained parameters: {:?}", val);
...
impl PartyPlayerUpdated {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyPlayerUpdated parameters: {:?}", val);
...
impl PartyInvitationPlayerBusy {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyInvitationPlayerBusy parameters: {:?}", val);
...
impl PartyMarkedObjectsUpdated {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyMarkedObjectsUpdated parameters: {:?}", val);
...
impl PartyOnClusterPartyJoined {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartyOnClusterPartyJoined parameters: {:?}", val);
...
impl PartySetRoleFlag {
    pub fn parse(val: Parameters) -> Option<Message> {
        println!("PartySetRoleFlag parameters: {:?}", val);
...
pub fn into_game_message(photon_message: photon_decode::Message) -> Option<Message> {
    println!("Raw photon : {:?}", photon_message);
